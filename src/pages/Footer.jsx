...
const Footer = () => {
  return (
    <>
      <footer className="font-sans tracking-wide px-8 py-12 mt-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-x-6 gap-y-10">
          <div>
            ...
            <ul className="mt-10 flex space-x-5 list-none">
              <li>
                <a href="/">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    className="fill-black hover:fill-gray-300 w-7 h-7"
                    viewBox="0 0 24 24"
                  >
                    <path
                      fillRule="evenodd"
          ...
          <div>
            ...
            <ul className="mt-6 space-y-5 list-none">
              <li>
                <a
                  href="/"
                  className="hover:text-black text-black text-sm"
                >
                  Web Development
                </a>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-5 mt-6 max-sm:hidden list-none">
              <li>
                <a
                  href="/"
                  className="hover:text-black text-black text-sm"
        ...
        <div className="flex flex-wrap max-md:flex-col gap-4">
          <ul className="md:flex md:space-x-6 max-md:space-y-2 list-none">
            <li>
              <a
                href="/"
                className="hover:text-black text-black text-sm"
          ...
          <p className="text-black text-sm md:ml-auto">
            © Shopper Stop  All rights reserved.
          </p>
        </div>
      </footer>
    </>
